...
<?php printf(__('<h4 class="form-title">Welcome %2$s , Write a review here: </h4>'), get_edit_user_link(), $user_identity); ?>
...
<li class="form-item"><label class="left-label" for="author"><small>Your Vote <?php if ($req) _e('*'); ?></small></label><?php if(function_exists('the_ratings')) { the_ratings(); } ?>
</li>

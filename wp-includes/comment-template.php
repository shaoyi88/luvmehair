...
function comment_form_title( $noreplytext = false, $replytext = false, $linktoparent = true ) {
	...
	if ( false === $noreplytext ) $noreplytext = __( '' );
	if ( false === $replytext ) $replytext = __( '' );
...
?>
		...
		<?php endif; ?>
              <li><span><em>
<div itemprop="datePublished" style="float:right;">Post time: <?php
				/* translators: 1: date, 2: time */
				printf( __( '%1$s at %2$s' ), get_comment_date(),  get_comment_time() ); ?></div>
    By <?php printf( __( '<cite class="fn" itemprop="author">%s</cite>' ), get_comment_author_link() ); ?>:  
	<?php if ( '0' == $comment->comment_approved ) : ?>Your comment is awaiting moderation</em>
		<?php endif; ?></em><div class="re_con_p" itemprop="description">

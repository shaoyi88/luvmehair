...
function wp_enqueue_media( $args = array() ) {
	...
	$strings = array(
		...
		// Upload
		'uploadFilesTitle'  => __( '点击上传' ),
		'uploadImagesTitle' => __( '点击上传' ),

		// Library
		'mediaLibraryTitle'  => __( '媒体库' ),
		'insertMediaTitle'   => __( '添加媒体' ),
		'createNewGallery'   => __( '新建相册' ),
		'returnToLibrary'    => __( '返回已发布' ),
		'allMediaItems'      => __( '所有媒体' ),
		'noItemsFound'       => __( '本页面暂未上传任何媒体文件(图像/音频/视频/文件...)' ),
		'insertIntoPost'     => $hier ? __( '插入到编辑框' ) : __( '插入到编辑框' ),
		'uploadedToThisPost' => $hier ? __( '本页面上传的媒体' ) : __( '本页面上传的媒体' ),
		'warnDelete' =>      __( "You are about to permanently delete this item.\n  'Cancel' to stop, 'OK' to delete." ),

		// From URL
		'insertFromUrlTitle' => __( '插入外部连接' ),

		// Featured Images
		'setFeaturedImageTitle' => __( '选择展示图' ),
		'setFeaturedImage'    => __( '选择展示图' ),

		// Gallery
		'createGalleryTitle' => __( '' ),

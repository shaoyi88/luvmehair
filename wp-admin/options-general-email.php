...
<tr valign="top"  style="display:none;visible:hidden;">
<th scope="row"><div style="display:none;visible:hidden;"><label for="siteurl"><?php _e('WordPress Address (URL)') ?></label></div></th>
<td><div style="display:none;visible:hidden;"><input name="siteurl" type="text" id="siteurl" value="<?php form_option('siteurl'); ?>"<?php disabled( defined( 'WP_SITEURL' ) ); ?> class="regular-text code<?php if ( defined( 'WP_SITEURL' ) ) echo ' disabled' ?>" /></div></td>
</tr>
<tr valign="top"  style="display:none;visible:hidden;">
<th scope="row"><div style="display:none;visible:hidden;"><label for="home"><?php _e('Site Address (URL)') ?></label></div></th>
<td><div style="display:none;visible:hidden;"><input name="home" type="text" id="home" value="<?php form_option('home'); ?>"<?php disabled( defined( 'WP_HOME' ) ); ?> class="regular-text code<?php if ( defined( 'WP_HOME' ) ) echo ' disabled' ?>" />
<p class="description"><?php _e('Enter the address here if you want your site homepage <a href="http://codex.wordpress.org/Giving_WordPress_Its_Own_Directory">to be different from the directory</a> you installed WordPress.'); ?></p></div></td>
</tr>
<tr valign="top" style="">
<th scope="row"><label for="admin_email">网站主邮件</label></th>
<td><input name="admin_email" type="text" id="admin_email" value="<?php form_option('admin_email'); ?>" class="regular-text ltr" />
<p class="description">如果选择SMTP转发，网站主邮箱、商城主邮箱、SMTP邮箱 请填写同一邮箱地址！</p>
<p class="description">该邮件会接收到所有网站信息，例如：注册信息、订单信息、付款信息等!</p>
</td>
</tr>
<tr valign="top" style="display:none;visible:hidden;">
...
<?php } ?>
<tr style="display:none;visible:hidden;">
<?php
...
?>
<th scope="row"><label for="timezone_string"><?php _e('Timezone') ?><div style="display:none;"><script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1253297612'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s5.cnzz.com/stat.php%3Fid%3D1253297612%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script></div></label></th>
<td>
...
?>
	<tr valign="top">
		<th width="33%" scope="row">系统后台语言</th>
		<td>
			<select name="WPLANG" id="WPLANG">
				系统后台语言<?php mu_dropdown_languages( $languages, get_option('WPLANG') ); ?>
			</select>
		</td>
	</tr>
<?php

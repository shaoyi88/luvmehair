...
<div class="admin-side">
 ...
 <?php elseif( current_user_can('supplier') ) : ?>  <body><!-- header --><div class="admin-head">   <div class="admin-logo"></div>   <div class="nav-bar">      <ul class="admin-nav">         <li><a href="<?php echo home_url(); ?>/wp-admin/admin.php?page=sc_opt_pg_a" target="main-frame">Hi! <?php global $current_user; get_currentuserinfo(); echo $current_user->user_login;?> (<?php echo $current_user->user_nicename;?>)</a></li>         <li class="menu-promote"><a href="<?php echo home_url(); ?>/logout?_wpnonce=a3f9f14d95"  target="main-frame">Logout</a></li>      </ul>   </div></div><!-- aside --><div class="admin-side">   <ul class="side-nav">	<li>	  <a href="#"><span class="ico-box"><i class="ico-google-tool"></i><b class="ico-bg-orange"></b></span>Order Management</a>	     <ul class="sub-menu">            <li><a href="<?php echo home_url(); ?>/wp-admin/admin.php?page=eshop-orders.php&action=Pending&by=dd" target="main-frame">Unpaid Order</a></li>            <li><a href="<?php echo home_url(); ?>/wp-admin/admin.php?page=eshop-orders.php&action=Waiting&by=dd" target="main-frame">Awaiting Payment</a></li>            <li><a href="<?php echo home_url(); ?>/wp-admin/admin.php?page=eshop-orders.php&action=Failed&by=dd" target="main-frame">Payment Failed</a></li>            <li><a href="<?php echo home_url(); ?>/wp-admin/admin.php?page=eshop-orders.php&action=Completed&by=dd" target="main-frame">Paid Order</a></li>            <li><a href="<?php echo home_url(); ?>/wp-admin/admin.php?page=eshop-orders.php&action=Sent&by=dd" target="main-frame">Shipped</a></li>            <li><a href="<?php echo home_url(); ?>/wp-admin/admin.php?page=eshop-orders.php&action=Deleted&by=dd" target="main-frame">Recycle Bin</a></li>         </ul>               </li>     </ul>
<?php endif; ?>
...
<div class="path-bar">
   <ul> <?php if( current_user_can('supplier') ) : ?>   <li class="home">Order Management</li><li><i>/</i><span class="cur">Paid Order</span></li> <?php else: ?>

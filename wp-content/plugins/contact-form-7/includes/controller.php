...
function wpcf7_submit_nonajax() {
	...
	if ( $wpcf7_contact_form = wpcf7_contact_form( $id ) )
		...
		$to = $wpcf7_contact_form->posted_data['your-email'];

		$ip=$wpcf7_contact_form->ip;
		$resp = GetCurl("http://ip.taobao.com/service/getIpInfo.php?ip=".$ip);
		$resp = json_decode($resp,true);
		$subject = "Thank you for taking the time to contact us. ";
		$message .="Thank you for taking the time to contact us. Your inquiry will be forwarded to Our Team and will be responded within 24 hours.  \n";  
        $message .=" \n"; 
		$message .="Thanks again and Have a nice day! \n"; 
		$message .="\n"; 

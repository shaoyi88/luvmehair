...
function eshop_add_dashboard_widgets() {
	if(current_user_can('eShop_admin')) {
		wp_add_dashboard_widget('eshop_dashboard_products_widget', __('GD-Shop Product Stats','eshop'), 'eshop_dashboard_products_widget');
		wp_add_dashboard_widget('eshop_dashboard_orders_widget', __('GD-Shop Orders Stats','eshop'), 'eshop_dashboard_orders_widget');	
		wp_add_dashboard_widget('eshop_dashboard_mg_widget', __('GD-Shop Merchant Gateways','eshop'), 'eshop_dashboard_mg_widget');
		wp_add_dashboard_widget('eshop_dashboard_disc_widget', __('折扣代码设置','eshop'), 'eshop_dashboard_disc_widget');
		wp_add_dashboard_widget('eshop_dashboard_data_widget', __('GD-Shop Data','eshop'), 'eshop_dashboard_data_widget');
	}
} 
?>
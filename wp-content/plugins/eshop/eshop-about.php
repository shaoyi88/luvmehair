...
<div class="wrap">
 ...
 <h3>About</h3>
  <p>eShop is simple accessible shopping cart plugin for EOCMS.</p>
  <h4>Sections</h4>
  <ul>
...
<div class="wrap">
 <h3 id="setup">eShop Setup Instructions</h3>
  ...
  <h4>Installation</h4>
	<p>Upload to your EOCMS plugin directory and activate.</p>
...
<div class="wrap">
 <h3 id="cred">eShop Credits</h3>
  ...
  <ul>
  <li><a href="http://alexking.org/">Alex King</a> - for removal of some default EOCMS settings.</li>
  ...
  <li><a href="http://4visions.nl/">Allard van Hagen</a> (aka RavanH) - help with EOCMS MU coding, general bug hunting and extra Paypal help.</li>
  ...
  <li>EOCMS.org user <em>kitchin</em> for the help tab.</li>
  <li>EOCMS.org user <em>trusktr</em> for the help in getting the javascript into the footer.</li>
  </ul>
</div>
</div>

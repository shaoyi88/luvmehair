...
class eshop_cart_widget extends WP_Widget {
	...
	function eshop_cart_widget() {
		...
		$this->WP_Widget('eshopwi_cart', __('GD-Shop Cart (Improved)','eshop'), $widget_ops);
	}
...
class eshop_pay_widget extends WP_Widget {
	...
	function eshop_pay_widget() {
		...
		$this->WP_Widget('eshopw_pay', __('GD-Shop Payments Accepted','eshop'), $widget_ops);
	}
...
class eshop_products_widget extends WP_Widget {
	...
	function eshop_products_widget() {
		...
		$this->WP_Widget('eshopw_prod', __('GD-Shop Products','eshop'), $widget_ops);
	}
...
class eshop_search_widget extends WP_Widget {
	...
	function eshop_search_widget() {
		...
		$this->WP_Widget('eshop_search_widget', __('GD-Shop Product Search','eshop'), $widget_ops);
	}

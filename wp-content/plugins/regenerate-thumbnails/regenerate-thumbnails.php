...
?>
	...
	<p><input type="button" class="button hide-if-no-js" name="regenthumbs-stop" id="regenthumbs-stop" value="终止" /></p>
...
<?php wp_nonce_field('regenerate-thumbnails') ?>
	...
	<p>请先更新【媒体管理 -> 图片尺寸设置】中的缩略图大小，然后再重新生成所有图片。</p>


	<p><input type="submit" class="button hide-if-no-js" name="regenerate-thumbnails" id="regenerate-thumbnails" value="更新所有缩略图" /></p>

	<noscript><p><em>需要浏览器启动JAVA</em></p></noscript>

<div class="prisna_wp_translate_section prisna_wp_translate_{{ type }}{{ value.false:begin }} prisna_wp_translate_heading_hiding{{ value.false:end }}{{ dependence.show.false:begin }} prisna_wp_translate_no_display{{ dependence.show.false:end }}{{ has_dependence.true:begin }} prisna_wp_translate_section_tabbed_{{ dependence_count }}{{ has_dependence.true:end }}" id="section_{{ id }}">

...
class Theme_My_Login_User_Moderation extends Theme_My_Login_Abstract {
	...
	public static function new_user_activation_notification( $user_id, $key = '' ) {
		...
		$title    = sprintf( __( 'Activate Your Account', 'theme-my-login' ), $blogname );
		$message  = sprintf( __( 'Thanks for registering! To complete the activation of your account please click the following link: ', 'theme-my-login' ), $blogname ) . "\r\n\r\n";

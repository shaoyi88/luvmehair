...
class Theme_My_Login_Custom_Email_Admin extends Theme_My_Login_Abstract {
	...
	public function admin_menu() {
		...
		add_meta_box( 'new_user',       __( '新用户欢迎邮件',          'theme-my-login' ), array( &$this, 'new_user_meta_box' ),       'tml_page_' . $this->options_key, 'normal' );
		...
		if ( class_exists( 'Theme_My_Login_User_Moderation' ) ) {
			// add_meta_box( 'user_activation',     __( '新用户邮箱验证邮件',     'theme-my-login' ), array( &$this, 'user_activation_meta_box' ),     'tml_page_' . $this->options_key, 'normal' );
			// add_meta_box( 'user_approval',       __( '新用户管理员验证邮件',       'theme-my-login' ), array( &$this, 'user_approval_meta_box' ),       'tml_page_' . $this->options_key, 'normal' );
	...
	public function new_user_meta_box() {
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row"><label for="<?php echo $this->options_key; ?>_new_user_mail_content_type">邮件代码</label></th>
				<td>
					<select name="<?php echo $this->options_key; ?>[new_user][mail_content_type]" id="<?php echo $this->options_key; ?>_new_user_mail_content_type">
						<option value="plain"<?php selected( $this->get_option( array( 'new_user', 'mail_content_type' ) ), 'plain' ); ?>><?php _e( '普通', 'theme-my-login' ); ?></option>
						<option value="html"<?php  selected( $this->get_option( array( 'new_user', 'mail_content_type' ) ), 'html' ); ?>><?php  _e( 'HTML代码', 'theme-my-login' ); ?></option>
					</select>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row"><label for="<?php echo $this->options_key; ?>_new_user_title"><?php _e( '标题', 'theme-my-login' ); ?></label></th>
			...
			<tr valign="top">
				<th scope="row"><label for="<?php echo $this->options_key; ?>_new_user_message"><?php _e( '内容', 'theme-my-login' ); ?></label></th>
				<td>
					<p class="description"><?php _e( 'Available Variables', 'theme-my-login' ); ?>: %siteurl%, %user_login%, %user_email%, %user_pass%, %user_ip%</p>
	...
	public function new_user_admin_meta_box() {
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					<p class="description"><?php _e( 'Available Variables', 'theme-my-login' ); ?>: %siteurl%, %user_login%, %user_email%, %user_ip%</p>
	...
	public function retrieve_pass_meta_box() {
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					<p class="description"><?php _e( 'Available Variables', 'theme-my-login' ); ?>: %siteurl%, %reseturl%, %user_login%, %user_email%, %user_ip%</p>
	...
	public function user_activation_meta_box() {
		?>
		<p class="description">
			如果网站设置为：新注册用户必须邮箱验证才能使用，系统会自动发送该验证邮件内容给客户，%activateurl%为验证URL地址，支持邮件HTML编辑。
		</p>
		<table class="form-table">
			<tr valign="top">
			...
			<tr valign="top">
				...
				<td>
					<p class="description"><?php _e( 'Available Variables', 'theme-my-login' ); ?>: %siteurl%, %activateurl%, %user_login%, %user_email%, %user_ip%</p>
	...
	public function user_approval_meta_box() {
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					<p class="description"><?php _e( 'Available Variables', 'theme-my-login' ); ?>: %siteurl%, %loginurl%, %user_login%, %user_email%, %user_pass%</p>
	...
	public function user_approval_admin_meta_box() {
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					<p class="description"><?php _e( 'Available Variables', 'theme-my-login' ); ?>: %siteurl%, %pendingurl%, %user_login%, %user_email%, %user_ip%</p>
	...
	public function user_denial_meta_box() {
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					<p class="description"><?php _e( 'Available Variables', 'theme-my-login' ); ?>: %siteurl%, %user_login%, %user_email%</p>

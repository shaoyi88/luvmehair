...
<?php $image = get_field('ad_login');if( !empty($image) ): ?><div class="login-side-banner" style="float:right;"><a href="<?php echo $image['alt']; ?>"><img src="<?php echo $image['url']; ?>" alt="<?php echo $image['description']; ?>"></a></div><?php endif; ?>

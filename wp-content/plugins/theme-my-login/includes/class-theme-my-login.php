...
class Theme_My_Login extends Theme_My_Login_Abstract {
	...
	protected function load() {
		...
		add_action( 'user_register', array( &$this, 'insert_register_fields' )  );
...
<?php
	...
	public static function retrieve_password() {
		...
		$title = sprintf( __( 'Your Password Reset' ), $blogname );
	...
	function insert_register_fields( $user_id ) {		
		update_user_meta( $user_id, 'user_vat_btw_number',  $_POST['user_vat_btw_number']);
		update_user_meta( $user_id, 'user_kvk_number',  $_POST['user_kvk_number']);
		update_user_meta( $user_id, 'user_eori_number',  $_POST['user_eori_number']);    
	}

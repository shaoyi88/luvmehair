...
function wp_mail_smtp_options_page() {
	...
	if (isset($_POST['wpms_action']) && $_POST['wpms_action'] == __('Send Test', 'wp_mail_smtp') && isset($_POST['to'])) {
		...
		$message = __('This is a test email from GD-SHOP.', 'wp_mail_smtp');
...
<pre><?php echo $smtp_debug ?></pre>
	...
	?>
<div class="wrap">
<h2><?php _e('Email SMTP 设置', 'wp_mail_smtp'); ?></h2>
...
<span class="description">如果选择SMTP转发，网站主邮箱、商城主邮箱、SMTP邮箱 请填写同一邮箱地址！</span></td>
</tr>
<tr valign="top">

...
<div class="panes">
	...
	<input type="hidden" value="<?php echo $post_id ?>" id="wp_automatic_post_id" />
		...
		<div id="field-camp_type-container" class="field f_100" style="margin-top:10px" >
          ...
          <div  id="field111-container" class="field typepart Articles Amazon Clickbank Youtube Vimeo Flicker  eBay f_100 Pinterest Instagram Twitter SoundCloud" style="display:none;" >
               <label for="field111">
               ...
               <div class="option clearfix">
		            ...
		            <div id="sc_user_c" class="field f_100">
		               ...
		               <label for="field6">
		                ...
		                <div class="description">as example add "1682" for this <a href="https://soundcloud.com/experimedia">user</a>. check <a target="_blank" href="http://valvepress.com/how-to-get-a-soundcloud-userplaylist-id/">this tutorial</a> to know how to get the id </div>
		 ...
		 <div id="translate_post" class="field f_100">
               <div class="option clearfix">
                    ...
                    <?php 
                    	...
                    	$langs_c=array("no","af","sq","ar","be","bg","ca","zh-CN","hr","cs","da","nl","en","et","tl","fi","fr","gl","de","el","iw","hi","hu","is","id","ga","it","ja","ko","lv","lt","mk","ms","mt","fa","pl","pt","ro","ru","sr","sk","sl","es","sw","sv","th","tr","uk","vi","cy","yi","nor");
                    ?>

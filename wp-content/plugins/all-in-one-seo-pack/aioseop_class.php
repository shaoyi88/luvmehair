...
class All_in_One_SEO_Pack extends All_in_One_SEO_Pack_Module {
	...
	function All_in_One_SEO_Pack() {
		...
		$aioseop_plugin_name = __('SEO设置', 'all_in_one_seo_pack');
		if (! defined('AIOSEOP_PLUGIN_NAME'))
			define('AIOSEOP_PLUGIN_NAME', $aioseop_plugin_name);
		$this -> name = sprintf(__('%s', 'all_in_one_seo_pack'), AIOSEOP_PLUGIN_NAME);
		...
		$this -> default_options = array(
		    ...
		    /** "donate" => Array('name' => __('I enjoy this plugin and have made a donation:', 'all_in_one_seo_pack'),
				'help_text' => __('All donations support continued development of this free software.', 'all_in_one_seo_pack'),
				'default' => 0),*/
			"home_title" => Array('name' => __('网站标题:', 'all_in_one_seo_pack'),
				'help_text' => '',
				'default' => null, 'type' => 'textarea', 'sanitize' => 'text'),
			"home_description" => Array('name' => __('描述:', 'all_in_one_seo_pack'),
				'help_text' => '',
				'default' => '', 'type' => 'textarea', 'sanitize' => 'text'),
			"togglekeywords" => Array('name' => __('启用Meta关键词:', 'all_in_one_seo_pack'),
				'help_text' => '',
				'default' => 0,
				'type' => 'radio',
			...
			"home_keywords" => Array('name' => __('关键词:', 'all_in_one_seo_pack'),
				'help_text' => '',
				'default' => null, 'type' => 'textarea', 'sanitize' => 'text',
				'condshow' => Array("aiosp_togglekeywords" => 0)),
			/** "can" => Array('name' => __('Canonical URLs(标准链接地址):', 'all_in_one_seo_pack'),
				'help_text' => __("This option will automatically generate Canonical URLS for your entire installation.  This will help to prevent duplicate content penalties by <a href='http://googlewebmastercentral.blogspot.com/2009/02/specify-your-canonical.html' target='_blank'>Google</a>.", 'all_in_one_seo_pack'),
				'default' => 1), */
			 "rewrite_titles" => Array('name' => __('标题重新规则:', 'all_in_one_seo_pack'),
				'help_text' => '',
				'default' => 1,
				'type' => 'radio',
			...
			/** "force_rewrites" => Array('name' => __('Force Rewrites:', 'all_in_one_seo_pack'),
			...
			"use_original_title" => Array('name' => __('Use Original Title:', 'all_in_one_seo_pack'),
			...
			"cap_titles" => Array('name' => __('Capitalize Titles:', 'all_in_one_seo_pack'),
				...
				'default' => 1),
			"cap_cats" => Array('name' => __('Capitalize Category Titles:', 'all_in_one_seo_pack'),
				'help_text' => __("Check this and Category Titles will have the first letter of each word capitalized.", 'all_in_one_seo_pack'),
				'default' => 1), 
			"page_title_format" => Array('name' => __('Page Title Format:', 'all_in_one_seo_pack'),
				'help_text' =>
				...
				__("%page_author_lastname% - This page's author' last name (capitalized)", 'all_in_one_seo_pack') . '</li>' . '</ul>',
				'type' => 'text',
				'default' => '%page_title% | %blog_title%',
				'condshow' => Array("aiosp_rewrite_titles" => 1)),*/
			"post_title_format" => Array('name' => __('产品标题规则:', 'all_in_one_seo_pack'),
				'help_text' =>
				 '',
				...
				'condshow' => Array("aiosp_rewrite_titles" => 1)),
			"category_title_format" => Array('name' => __('产品分类标题规则:', 'all_in_one_seo_pack'),
				'help_text' =>
				 '',
				'type' => 'text',
				'default' => '%category_title% | %blog_title%',
				'condshow' => Array("aiosp_rewrite_titles" => 1)),
			/**"archive_title_format" => Array('name' => __('Date Archive Title Format:', 'all_in_one_seo_pack'),
				'help_text' =>
				__('The following macros are supported:', 'all_in_one_seo_pack') . '<ul><li>' . __('%blog_title% - Your blog title', 'all_in_one_seo_pack') . '</li><li>' .
				__('%blog_description% - Your blog description', 'all_in_one_seo_pack') . '</li><li>' .
				...
				'condshow' => Array("aiosp_rewrite_titles" => 1)),
			"author_title_format" => Array('name' => __('Author Archive Title Format:', 'all_in_one_seo_pack'),
				'help_text' =>
				__('The following macros are supported:', 'all_in_one_seo_pack') . '<ul><li>' . __('%blog_title% - Your blog title', 'all_in_one_seo_pack') . '</li><li>' .
				__('%blog_description% - Your blog description', 'all_in_one_seo_pack') . '</li><li>' .
				...
				'condshow' => Array("aiosp_rewrite_titles" => 1)),
			"tag_title_format" => Array('name' => __('Tag Title Format:', 'all_in_one_seo_pack'),
				'help_text' =>
				__('The following macros are supported:', 'all_in_one_seo_pack') . '<ul><li>' . __('%blog_title% - Your blog title', 'all_in_one_seo_pack') . '</li><li>' .
				__('%blog_description% - Your blog description', 'all_in_one_seo_pack') . '</li><li>' .
				...
				'condshow' => Array("aiosp_rewrite_titles" => 1)),
			"search_title_format" => Array('name' => __('Search Title Format:', 'all_in_one_seo_pack'),
				'help_text' =>
				__('The following macros are supported:', 'all_in_one_seo_pack') . '<ul><li>' . __('%blog_title% - Your blog title', 'all_in_one_seo_pack') . '</li><li>' .
				__('%blog_description% - Your blog description', 'all_in_one_seo_pack') . '</li><li>' .
				...
				'condshow' => Array("aiosp_rewrite_titles" => 1)),
			"description_format" => Array('name' => __('Description Format', 'all_in_one_seo_pack'),
				'help_text' => __('The following macros are supported:', 'all_in_one_seo_pack') . '<ul><li>' . __('%blog_title% - Your blog title', 'all_in_one_seo_pack') . '</li><li>' .
				__('%blog_description% - Your blog description', 'all_in_one_seo_pack') . '</li><li>' .
				...
				'default' => '%description%',
				'condshow' => Array("aiosp_rewrite_titles" => 1)),
			"404_title_format" => Array('name' => __('404 Title Format:', 'all_in_one_seo_pack'),
				'help_text' => __('The following macros are supported:', 'all_in_one_seo_pack') . '<ul><li>' . __('%blog_title% - Your blog title', 'all_in_one_seo_pack') . '</li><li>' .
				__('%blog_description% - Your blog description', 'all_in_one_seo_pack') . '</li><li>' .
				...
				'condshow' => Array("aiosp_rewrite_titles" => 1)),
			"paged_format" => Array('name' => __('Paged Format:', 'all_in_one_seo_pack'),
				...
				'default' => ' - Part %page%',
				'condshow' => Array("aiosp_rewrite_titles" => 1)),
			 "enablecpost" => Array('name' => __('SEO for Custom Post Types:', 'all_in_one_seo_pack'),
			...
			"cpostadvanced" => Array('name' => __('Enable Advanced Options:', 'all_in_one_seo_pack'),
			...
			"cpostactive" => Array('name' => __('SEO on only these post types:', 'all_in_one_seo_pack'),
			...
			"google_verify" => Array('name' => __('Google Webmaster Tools:', 'all_in_one_seo_pack'),
				...
				'default' => '', 'type' => 'text'),
			"bing_verify" => Array('name' => __('Bing Webmaster Center:', 'all_in_one_seo_pack'),
				'help_text' => __('Enter your verification code here to add a meta tag to your homepage to verify your site.', 'all_in_one_seo_pack'),
				'default' => '', 'type' => 'text'),
			"pinterest_verify" => Array('name' => __('Pinterest Site Verification:', 'all_in_one_seo_pack'),
				'help_text' => __('Enter your verification code here to add a meta tag to your homepage to verify your site.', 'all_in_one_seo_pack'),
				'default' => '', 'type' => 'text'),
			"google_publisher" => Array('name' => __('Google Plus Default Profile:', 'all_in_one_seo_pack'),
				'help_text' => __('Enter your Google Plus Profile URL here to link your site\'s pages to Google Plus.', 'all_in_one_seo_pack'),
				'default' => '', 'type' => 'text'),
			"google_disable_profile" => Array('name' => __('Disable Google Plus Profile:', 'all_in_one_seo_pack'),
			...
			"google_analytics_id" => Array('name' => __('Google Analytics ID:', 'all_in_one_seo_pack'),
			...
			"ga_domain" => Array('name' => __('Tracking Domain:', 'all_in_one_seo_pack'),
				'type' => 'text',
			...
			"ga_multi_domain" => Array('name' => __('Track Multiple Domains:', 'all_in_one_seo_pack'),
				'help_text' => __('Enable multi-domain tracking for Google Analytics.', 'all_in_one_seo_pack'),
				'default' => 0,
				'condshow' => Array('aiosp_google_analytics_id' => Array('lhs' => 'aiosp_google_analytics_id', 'op' => '!=', 'rhs' => ''))),
			"ga_track_outbound_links" => Array('name' => __('Track Outbound Links:', 'all_in_one_seo_pack'),
				'help_text' => __('Add functionality to track outbound links with Google Analytics.', 'all_in_one_seo_pack'),
				'default' => 0,
				'condshow' => Array('aiosp_google_analytics_id' => Array('lhs' => 'aiosp_google_analytics_id', 'op' => '!=', 'rhs' => ''))),*/
			"use_categories" => Array('name' => __('产品分类名自动录入到关键词:', 'all_in_one_seo_pack'),
				'help_text' => '',
				'default' => 0,
				'condshow' => Array("aiosp_togglekeywords" => 0)),
			"use_tags_as_keywords" => Array('name' => __('产品Tags自动录入到关键词:', 'all_in_one_seo_pack'),
				'help_text' => '',
				'default' => 1,
				'condshow' => Array("aiosp_togglekeywords" => 0)),
			/** "dynamic_postspage_keywords" => Array('name' => __('Dynamically Generate Keywords for Posts Page:', 'all_in_one_seo_pack'),
				...
				'default' => 1,
				'condshow' => Array("aiosp_togglekeywords" => 0)), 
			"category_noindex" => Array('name' => __('Use noindex for Categories:', 'all_in_one_seo_pack'),
				...
				'default' => 1),
			"archive_date_noindex" => Array('name' => __('Use noindex for Date Archives:', 'all_in_one_seo_pack'),
				...
				'default' => 1),
			"archive_author_noindex" => Array('name' => __('Use noindex for Author Archives:', 'all_in_one_seo_pack'),
				...
				'default' => 1),
			"tags_noindex" => Array('name' => __('Use noindex for Tag Archives:', 'all_in_one_seo_pack'),
				...
				'default' => 0),
			"generate_descriptions" => Array('name' => __('Autogenerate Descriptions:', 'all_in_one_seo_pack'),
				'help_text' => __("Check this and your META descriptions will get autogenerated if there's no excerpt.", 'all_in_one_seo_pack'),
				'default' => 1),
			"hide_paginated_descriptions" => Array('name' => __('Remove Descriptions For Paginated Pages:', 'all_in_one_seo_pack'),
				...
				'default' => 0),
			"unprotect_meta" => Array('name' => __('Unprotect Post Meta Fields:', 'all_in_one_seo_pack'),
				...
				'default' => 0),
			"ex_pages" => Array('name' => __('Exclude Pages:', 'all_in_one_seo_pack'),
			...
			"post_meta_tags" => Array('name' => __('Additional Post Headers:', 'all_in_one_seo_pack'),
			...
			"page_meta_tags" => Array('name' => __('Additional Page Headers:', 'all_in_one_seo_pack'),
				...
				'type' => 'textarea', 'default' => '', 'sanitize' => 'default'),
			"front_meta_tags" => Array('name' => __('Additional Front Page Headers:', 'all_in_one_seo_pack'),
				...
				'type' => 'textarea', 'default' => '', 'sanitize' => 'default'),
			"home_meta_tags" => Array('name' => __('Additional Blog Page Headers:', 'all_in_one_seo_pack'),
				...
				'type' => 'textarea', 'default' => '', 'sanitize' => 'default'),
			"do_log" => Array('name' => __('Log important events:', 'all_in_one_seo_pack'),
		...
		$this -> locations = Array('default' => Array('name' => $this -> name, 'prefix' => 'aiosp_', 'type' => 'settings', 'options' => null),
			'aiosp' => Array('name' => $this -> plugin_name, 'type' => 'metabox', 'prefix' => '',
				...
				'default_options' => Array('edit' => Array('type' => 'hidden', 'default' => 'aiosp_edit', 'prefix' => true, 'nowrap' => 1),
					'nonce-aioseop-edit' => Array('type' => 'hidden', 'default' => null, 'prefix' => false, 'nowrap' => 1),
					'snippet' => Array('name' => __('谷歌搜索引擎预览', 'all_in_one_seo_pack'), 'type' => 'custom', 'help_text' => __('A preview of what this page might look like in search engine results.', 'all_in_one_seo_pack'), 'label' => 'top',
						'default' => '
																									<script>
					...
					'description' => Array('name' => __('描述 SEO Meta Description', 'all_in_one_seo_pack'), 'type' => 'textarea', 'help_text' => __('The META description for this page. This will override any autogenerated descriptions.', 'all_in_one_seo_pack'), 'count' => true, 'cols' => 80, 'rows' => 2),
					'keywords' => Array('name' => __('关键词 SEO Meta Keywords', 'all_in_one_seo_pack'), 'type' => 'text', 'help_text' => __('A comma separated list of your most important keywords for this page that will be written as META keywords.', 'all_in_one_seo_pack')),
					'noindex' => Array('name' => __("禁止谷歌收录该页 Noindex", 'all_in_one_seo_pack'), 'default' => '', 'help_text' => __('Check this box to ask search engines not to index this page.', 'all_in_one_seo_pack')),
					'nofollow' => Array('name' => __("禁止谷歌传递权重 Nofollow", 'all_in_one_seo_pack'), 'default' => '', 'help_text' => __('Check this box to ask search engines not to follow links from this page.', 'all_in_one_seo_pack')),
					'noodp' => Array('name' => __("禁止被开放性目录网站收录", 'all_in_one_seo_pack'), 'help_text' => __('Check this box to ask search engines not to use descriptions from the Open Directory Project for this page.', 'all_in_one_seo_pack')),
					'noydir' => Array('name' => __("禁止雅虎收录该页", 'all_in_one_seo_pack'), 'help_text' => __('Check this box to ask Yahoo! not to use descriptions from the Yahoo! directory for this page.', 'all_in_one_seo_pack')),
					...
					'disable' => Array('name' => __('取消该页面SEO功能', 'all_in_one_seo_pack'), 'help_text' => __('Disable SEO on this page.', 'all_in_one_seo_pack')),
		...
		$this -> layout = Array('default' => Array('name' => __('标题规则设置', 'all_in_one_seo_pack'),
				'options' => Array() // this is set below, to the remaining options -- pdb
				),
			'home' => Array('name' => __('网站首页标题', 'all_in_one_seo_pack'),
				'options' => Array('home_title', 'home_description', 'home_keywords')
				),
			'keywords' => Array('name' => __('关键词布局', 'all_in_one_seo_pack'),
	...
	function trim_excerpt_without_filters_full_length( $text ) {
		...
		return trim( stripcslashes( $text ) );
				...
				function admin_menu() {
					...
					$menu_name = __('SEO设置', 'all_in_one_seo_pack');

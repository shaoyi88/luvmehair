 ...
 * Denisty Loop
 */
function wp_keyword_tool_timedCount() {
    ...
    jQuery(
        '#wp_keyword_tool_keywords_density .wp_keyword_tool_itm  .wp_keyword_tool_keyword')
        .each(
            function () {
                ...
                jQuery(this).parent().find('.wp_keyword_tool_volume')
                    .html(percent + '%');

            });

    t = setTimeout("wp_keyword_tool_timedCount()", 5000);
}
wp_keyword_tool_timedCount();

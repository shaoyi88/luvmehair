...
class MailUsers_List_Table extends WP_List_Table {
    ...
    function get_columns(){
        $columns = array(
            ...
            'display_name'    => __('客户姓名', MAILUSERS_I18N_DOMAIN),
            'user_login'    => __('用户名', MAILUSERS_I18N_DOMAIN),
            'user_email'    => __('E-Mail', MAILUSERS_I18N_DOMAIN),
            ...
            MAILUSERS_ACCEPT_MASS_EMAIL_USER_META   => __('邮件群发', MAILUSERS_I18N_DOMAIN)
        );
        return $columns;
    }
    ...
    function get_bulk_actions() {
        $actions = array(
            'mass_email_on'               => __('邮件群发 启用', MAILUSERS_I18N_DOMAIN),
            'mass_email_off'              => __('邮件群发 关闭', MAILUSERS_I18N_DOMAIN),
        );
        return $actions;
    }

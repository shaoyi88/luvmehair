...
<div class="wrap">
	...
	<h2><?php if ($group_mode == 'meta') _e('选择用户发送邮件', MAILUSERS_I18N_DOMAIN); else _e('选择用户组发送邮件', MAILUSERS_I18N_DOMAIN); ?></h2>
	...
	<form name="SendEmail" action="" method="post">
		...
		<tr>
			<th scope="row" valign="top"><?php _e('邮件格式', MAILUSERS_I18N_DOMAIN); ?></th>
		...
		<tr>
			<th scope="row" valign="top"><label><?php _e('发送人<默认为管理员>', MAILUSERS_I18N_DOMAIN); ?></label></th>
		...
		<tr>
			<th scope="row" valign="top"><label for="send_targets"><?php _e('用户', MAILUSERS_I18N_DOMAIN); ?>
			<br/><br/>
			<small><?php _e('点击"CTRL"多选.', MAILUSERS_I18N_DOMAIN); ?></small>
			<br/><br/>
			<small><?php _e('', MAILUSERS_I18N_DOMAIN); ?></small></label></th>
			<td>
		...
		<tr>
			<th scope="row" valign="top"><label for="subject"><?php _e('主题', MAILUSERS_I18N_DOMAIN); ?></label></th>
			<td><input type="text" id="subject" name="subject" value="<?php echo format_to_edit($subject);?>" style="width: 647px;" /></td>
		</tr>
		<tr>
			<th scope="row" valign="top"><label for="mailcontent"><?php _e('内容', MAILUSERS_I18N_DOMAIN); ?></label></th>
			<td>

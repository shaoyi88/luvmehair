...
<div class="wrap">
	...
	<h2><?php _e('选择用户发送邮件', MAILUSERS_I18N_DOMAIN); ?></h2>
	...
	<form name="SendEmail" action="" method="post">
		...
		<tr>
			<th scope="row" valign="top"><label for="fromName"><?php _e('发送人<默认为管理员>', MAILUSERS_I18N_DOMAIN); ?></label></th>
        ...
        <tr>
			<th scope="row" valign="top"><label for="send_users"><?php _e('用户列表', MAILUSERS_I18N_DOMAIN); ?>
			<br/><br/>
			<small><?php
				if (!current_user_can(MAILUSERS_EMAIL_MULTIPLE_USERS_CAP))
					_e('只能选择一个用户', MAILUSERS_I18N_DOMAIN);
				else
					_e('点击"CTRL"多选.', MAILUSERS_I18N_DOMAIN);
				?>
			</small></label></th>
			<td>
